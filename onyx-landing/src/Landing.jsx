...
const MODULES = [
  {
    ...
    description: "Surveillez automatiquement des centaines de sources web. ONYX Radar scrape, collecte et centralise toute l'information pertinente pour votre organisation â€” en temps rÃ©el.",
    features: ["Scraping automatique multi-sources", "Flux RSS, sites web, rÃ©seaux sociaux", "DÃ©tection de nouveaux contenus en temps rÃ©el", "CatÃ©gorisation intelligente", "Gestion des doublons"],
    icon: "â—Ž",
    color: "#00f0ff",
  ...
  },
  {
    ...
    description: "Comprenez ce qui se dit et ce qui se prÃ©pare. ONYX Pulse analyse le sentiment, dÃ©tecte les signaux faibles et vous alerte avant tout le monde.",
    features: ["Analyse de sentiment par IA", "DÃ©tection de tendances Ã©mergentes", "Alertes intelligentes en temps rÃ©el", "Suivi de rÃ©putation", "Cartographie des opinions"],
    icon: "â—ˆ",
    color: "#b026ff",
  ...
  },
  {
    ...
    description: "Visualisez tout d'un coup d'Å“il. ONYX Board transforme vos donnÃ©es de veille en dashboards interactifs, classements et indicateurs actionnables.",
    features: ["Dashboards personnalisables", "Classements et scoring", "Visualisations temps rÃ©el", "Filtres multi-dimensions", "Widgets modulaires"],
    icon: "â—‡",
    color: "#ffb800",
  ...
  },
  {
    ...
    description: "Transformez votre veille en livrables professionnels. ONYX Brief gÃ©nÃ¨re automatiquement des prÃ©sentations PowerPoint et des rapports Word prÃªts Ã  partager.",
    features: ["Export PowerPoint automatique", "Rapports Word structurÃ©s", "Templates personnalisables", "SynthÃ¨ses IA", "Planification d'envois"],
    icon: "â—†",
    color: "#00ff87",
...
const USECASES = [
  { title: "Veille Concurrentielle", desc: "Suivez vos concurrents en temps rÃ©el", icon: "âš”", color: "#ff003c" },
  { title: "Veille RÃ©glementaire", desc: "Ne manquez plus aucun dÃ©cret ou directive", icon: "âš–", color: "#b026ff" },
  { title: "Veille Politique", desc: "Anticipez les dÃ©cisions qui impactent votre secteur", icon: "ðŸ›", color: "#ffb800" },
  { title: "Veille MÃ©dias & RÃ©putation", desc: "ContrÃ´lez votre image en temps rÃ©el", icon: "ðŸ“¡", color: "#00f0ff" },
  { title: "Veille Technologique", desc: "Restez Ã  la pointe de l'innovation", icon: "âš¡", color: "#00ff87" },
  { title: "Intelligence Ã‰conomique", desc: "Prenez des dÃ©cisions basÃ©es sur les donnÃ©es", icon: "â—ˆ", color: "#0080ff" },
];
    ...
    <div style={{
      ...
      <section style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "120px 40px 80px" }}>
        ...
        <p style={{
          ...
          ONYX rÃ©unit collecte, analyse, visualisation et reporting dans un Ã©cosystÃ¨me unifiÃ©. Fini les 10 outils sÃ©parÃ©s â€” voyez tout, ne manquez rien.
        </p>
        ...
        <div style={{
          ...
          {[
            { value: "4", suffix: "", label: "Modules intÃ©grÃ©s" },
            { value: "100", suffix: "+", label: "Types de sources" },
            { value: "360", suffix: "Â°", label: "Couverture de veille" },
            { value: "1", suffix: "", label: "Plateforme unifiÃ©e" },
          ].map((s, i) => (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: "#ffffff77", lineHeight: 2 }}>
              Google Alerts + Feedly + Mention + Excel + PowerPoint + Email + ... ðŸ˜µ
            </div>
            <div style={{
              fontFamily: "'JetBrains Mono', monospace",
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: "#ffffff77", lineHeight: 2 }}>
              Tout est connectÃ©, tout est centralisÃ©, tout est automatisÃ©.
            </div>
            <div style={{
              fontFamily: "'JetBrains Mono', monospace",
      ...
      <section style={{ ...sectionStyle }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <p style={{ color: "#ffffff55", fontSize: 16, maxWidth: 500, margin: "0 auto" }}>
            Chaque module est puissant seul. Ensemble, ils sont inarrÃªtables.
          </p>
        </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p style={{
            ...
            Chaque module alimente les autres. Radar collecte â†’ Pulse analyse â†’ Board visualise â†’ Brief exporte. Un flux continu, sans friction.
          </p>
          ...
          <div style={{
            ...
            {[
              { text: "DonnÃ©es partagÃ©es entre modules", icon: "ðŸ”—" },
              { text: "ZÃ©ro configuration, zÃ©ro friction", icon: "âš¡" },
              { text: "Un seul abonnement pour tout", icon: "ðŸ’Ž" },
            ].map((item, i) => (
              <div key={i} style={{
                padding: "12px 24px",
                borderRadius: 100,
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Rejoignez les organisations qui ne manquent plus rien. Commencez avec ONYX Radar â€” c'est gratuit.
          </p>
          <button onClick={onOpenRadar} style={{
            padding: "18px 48px",
            borderRadius: 12,
      ...
      <footer style={{
        ...
        <div style={{
          ...
          INTELLIGENCE SUITE â€” RADAR Â· PULSE Â· BOARD Â· BRIEF
        </div>
        <div style={{
          fontFamily: "'JetBrains Mono', monospace",
          ...
          Â© 2026 ONYX / Clookys â€” See everything. Miss nothing.
        </div>
      </footer>
