      ...
      <aside style={{width:col?44:225,minWidth:col?44:225,borderRight:"1px solid #ffffff05",background:"#090912",display:"flex",flexDirection:"column",transition:"0.25s",overflow:"hidden"}}>
        <div style={{padding:col?"10px 5px":"10px 10px",borderBottom:"1px solid #ffffff04",display:"flex",alignItems:"center",justifyContent:col?"center":"space-between"}}>
          {!col&&<div style={{display:"flex",alignItems:"center",gap:5}}>
            {onBack&&<button type="button" onClick={onBack} style={{background:"none",border:"1px solid #ffffff0d",borderRadius:4,color:"#ffffff33",cursor:"pointer",padding:"3px 6px",fontSize:8,fontFamily:"'JetBrains Mono',monospace"}} onMouseEnter={e=>{e.target.style.color="#00f0ff";e.target.style.borderColor="#00f0ff33";}} onMouseLeave={e=>{e.target.style.color="#ffffff33";e.target.style.borderColor="#ffffff0d";}}>←</button>}
            <div style={{width:20,height:20,borderRadius:4,background:"linear-gradient(135deg, #00f0ff, #b026ff)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:8,fontWeight:900,fontFamily:"'Orbitron',sans-serif",boxShadow:"0 0 8px rgba(0,240,255,0.2)"}}>O</div><div><div style={{fontFamily:"'Orbitron',sans-serif",fontSize:9,fontWeight:700,letterSpacing:3,background:"linear-gradient(90deg, #00f0ff, #b026ff)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>ONYX</div><div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:6,letterSpacing:2,color:"#ffffff15"}}>RADAR</div></div>
          </div>}
          <div style={{display:"flex",alignItems:"center",gap:4}}>
            {!col&&onLogout&&<button type="button" onClick={onLogout} style={{background:"none",border:"none",color:"#ffffff10",cursor:"pointer",fontSize:7,fontFamily:"'JetBrains Mono',monospace"}} onMouseEnter={e=>{e.target.style.color="#ff003c";}} onMouseLeave={e=>{e.target.style.color="#ffffff10";}}>logout</button>}
